...
public class FlyingEnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (Vector3.Distance(transform.position, PlayerScript.instancia.transform.position) > distanceToAttackPlayer)
            {
            ...
            else
            {
                ...
                {
                    attackTarget = PlayerScript.instancia.transform.position;
                }
